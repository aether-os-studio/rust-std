...
fn carrying_mul_add_fallback_u128() {
    assert_eq!(
        fallback_cma::<u128>(u128::MAX, u128::MAX, 0, 0),
        (1, u128::MAX - 1)
    );
    assert_eq!(fallback_cma::<u128>(1, 1, 1, 1), (3, 0));
    assert_eq!(
        fallback_cma::<u128>(0, 0, u128::MAX, u128::MAX),
        (u128::MAX - 1, 1)
    );
    assert_eq!(
    ...
    assert_eq!(
        r,
        (
            0x8050ec20ed554e40338d277e00b674e7,
            0x1739ee6cea07da409182d003859b59d8
        )
    );
    let r = fallback_cma::<u128>(
    ...
    assert_eq!(
        r,
        (
            0x185525545fdb2fefb502a3a602efd628,
            0x1b62d35fe3bff6b566f99667ef7ebfd6
        )
    );
}
