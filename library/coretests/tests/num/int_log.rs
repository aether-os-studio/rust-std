...
fn checked_ilog() {
    ...
    assert_eq!(
        147808829414345923316083210206383297601u128.checked_ilog(3),
        Some(80)
    );
    assert_eq!(
        147808829414345923316083210206383297600u128.checked_ilog(3),
        Some(79)
    );
    assert_eq!(
        22528399544939174411840147874772641u128.checked_ilog(19683),
        Some(8)
    );
    assert_eq!(
        22528399544939174411840147874772631i128.checked_ilog(19683),
        Some(7)
    );
...
fn checked_ilog2() {
    ...
    assert_eq!(
        8192u16.checked_ilog2(),
        Some(round_down_imprecise((8192f32).log2()))
    );
    assert_eq!(
        32768u16.checked_ilog2(),
        Some(round_down_imprecise((32768f32).log2()))
    );
    assert_eq!(
        8192i16.checked_ilog2(),
        Some(round_down_imprecise((8192f32).log2()))
    );
