...
fn wrapping_int_api() {
    ...
    assert_eq!(
        (0xfedc_ba98_u32 as i32).wrapping_mul(16),
    ...
    match () {
        ...
        () => {
            assert_eq!(
                (0xfedc_ba98_u32 as isize).wrapping_mul(16),
    ...
    assert_eq!(
        (0xfedc_ba98_7654_3217 as u64).wrapping_mul(16),
    ...
    match () {
        ...
        () => {
            assert_eq!(
                (0xfedc_ba98 as usize).wrapping_mul(16),
