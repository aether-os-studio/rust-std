...
fn test_steps_between() {
    assert_eq!(
        Step::steps_between(&20_u8, &200_u8),
        (180_usize, Some(180_usize))
    );
    assert_eq!(
        Step::steps_between(&-20_i8, &80_i8),
        (100_usize, Some(100_usize))
    );
    assert_eq!(
        Step::steps_between(&-120_i8, &80_i8),
        (200_usize, Some(200_usize))
    );
    assert_eq!(
    ...
    assert_eq!(
        Step::steps_between(&-20_i32, &80_i32),
        (100_usize, Some(100_usize))
    );
    assert_eq!(
    ...
    assert_eq!(
        Step::steps_between(&20_u128, &200_u128),
        (180_usize, Some(180_usize))
    );
    assert_eq!(
        Step::steps_between(&-20_i128, &80_i128),
        (100_usize, Some(100_usize))
    );
    ...
    assert_eq!(
        Step::steps_between(&10_u128, &0x1_0000_0000_0000_000a_u128),
        (usize::MAX, None)
    );
    assert_eq!(
        Step::steps_between(&10_i128, &0x1_0000_0000_0000_000a_i128),
        (usize::MAX, None)
    );
    assert_eq!(
        Step::steps_between(
...
fn test_step_forward() {
    ...
    assert_eq!(
        Step::forward_checked(-20_030_i16, 50_050_usize),
        Some(30_020_i16)
    );
    ...
    assert_eq!(
        Step::forward_checked(10_u128, 70_000_usize),
        Some(70_010_u128)
    );
    assert_eq!(
        Step::forward_checked(10_i128, 70_030_usize),
        Some(70_040_i128)
    );
    assert_eq!(
...
fn test_step_backward() {
    ...
    assert_eq!(
        Step::backward_checked(30_020_i16, 50_050_usize),
        Some(-20_030_i16)
    );
    ...
    assert_eq!(
        Step::backward_checked(70_010_u128, 70_000_usize),
        Some(10_u128)
    );
    assert_eq!(
        Step::backward_checked(70_020_i128, 70_030_usize),
        Some(-10_i128)
    );
    assert_eq!(Step::backward_checked(10_u128, 7_usize), Some(3_u128));
    assert_eq!(Step::backward_checked(10_u128, 11_usize), None);
    assert_eq!(
        Step::backward_checked(
