...
fn abs_diff() {
    assert_eq!(
        Duration::new(2, 0).abs_diff(Duration::new(1, 0)),
        Duration::new(1, 0)
    );
    assert_eq!(
        Duration::new(1, 0).abs_diff(Duration::new(2, 0)),
        Duration::new(1, 0)
    );
    assert_eq!(
        Duration::new(1, 0).abs_diff(Duration::new(1, 0)),
        Duration::new(0, 0)
    );
    assert_eq!(
        Duration::new(1, 1).abs_diff(Duration::new(0, 2)),
        Duration::new(0, 999_999_999)
    );
    assert_eq!(
        Duration::new(1, 1).abs_diff(Duration::new(2, 1)),
        Duration::new(1, 0)
    );
...
fn saturating_add() {
    assert_eq!(
        Duration::new(0, 0).saturating_add(Duration::new(0, 1)),
        Duration::new(0, 1)
    );
    assert_eq!(
    ...
    assert_eq!(
        Duration::new(1, 0).saturating_add(Duration::new(u64::MAX, 0)),
        Duration::MAX
    );
}
...
fn checked_sub() {
    assert_eq!(
        Duration::NANOSECOND.checked_sub(Duration::ZERO),
...
fn saturating_sub() {
    assert_eq!(
        Duration::NANOSECOND.saturating_sub(Duration::ZERO),
        Duration::NANOSECOND
    );
    assert_eq!(
    ...
    assert_eq!(
        Duration::ZERO.saturating_sub(Duration::NANOSECOND),
        Duration::ZERO
    );
    assert_eq!(
        Duration::ZERO.saturating_sub(Duration::SECOND),
        Duration::ZERO
    );
}
...
fn saturating_mul() {
    ...
    assert_eq!(
        Duration::new(0, 500_000_001).saturating_mul(4),
        Duration::new(2, 4)
    );
    assert_eq!(
        Duration::new(0, 500_000_001).saturating_mul(4000),
        Duration::new(2000, 4000)
    );
    assert_eq!(
        Duration::new(u64::MAX - 1, 0).saturating_mul(2),
        Duration::MAX
    );
}
...
fn div_duration_f32() {
    ...
    assert_eq!(
        Duration::MAX.div_duration_f32(Duration::ZERO),
        f32::INFINITY
    );
    assert_eq!(
        (Duration::SECOND * 2).div_duration_f32(Duration::SECOND),
        2.0
    );
...
fn div_duration_f64() {
    ...
    assert_eq!(
        Duration::MAX.div_duration_f64(Duration::ZERO),
        f64::INFINITY
    );
    assert_eq!(
        (Duration::SECOND * 2).div_duration_f64(Duration::SECOND),
        2.0
    );
...
fn debug_formatting_padding() {
    ...
    assert_eq!(
        "999.123456ms",
        format!("{:<9?}", Duration::new(0, 999_123_456))
    );
    assert_eq!(
        "999.123456ms",
        format!("{:>9?}", Duration::new(0, 999_123_456))
