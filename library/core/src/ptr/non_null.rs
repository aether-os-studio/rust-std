...
impl<T: ?Sized> NonNull<T> {
        ...
        T: Sized,
    {
        ...
        unsafe {
            NonNull {
                pointer: intrinsics::offset(self.as_ptr(), count),
            }
        }
    }
    ...
    pub const unsafe fn byte_offset(self, count: isize) -> Self {
        ...
        unsafe {
            NonNull {
                pointer: self.as_ptr().byte_offset(count),
            }
        }
    }
    ...
    pub const unsafe fn byte_add(self, count: usize) -> Self {
        ...
        unsafe {
            NonNull {
                pointer: self.as_ptr().byte_add(count),
            }
        }
    }
    ...
    pub const unsafe fn byte_sub(self, count: usize) -> Self {
        ...
        unsafe {
            NonNull {
                pointer: self.as_ptr().byte_sub(count),
            }
        }
    }
    ...
    #[stable(feature = "non_null_convenience", since = "1.80.0")]
    #[rustc_const_stable(
        feature = "const_inherent_ptr_replace",
