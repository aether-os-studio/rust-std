    ...
    F: FnMut(I::Item) -> Option<B>,
{
    ...
    fn next_chunk<const N: usize>(
        ...
        let result = self.iter.try_for_each(|element| {
            ...
            unsafe {
                let opt_payload_at: *const MaybeUninit<B> = (&raw const val)
    ...
    {
        self.iter
            .try_fold(init, filter_map_try_fold(&mut self.f, fold))
    }
    ...
    F: FnMut(I::Item) -> Option<B>,
{
    ...
    {
        self.iter
            .try_rfold(init, filter_map_try_fold(&mut self.f, fold))
    }
